...
function analyzeColor(){
    ...
    if (userColor == "red"){
        ...
        return(" \"" + userColor + " like the veins in your arms,\" said Dracula.");
    } else if (userColor == "black"){
        return(" \"" + userColor + " like the color of night,\" said Dracula.");
    } else if (userColor == "yellow"){
        return(" \"" + userColor + " like the color of the sun....oh noooo,\" said Dracula.");
    } else {
